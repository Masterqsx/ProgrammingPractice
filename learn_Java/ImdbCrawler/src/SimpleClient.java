...
public class SimpleClient implements Runnable{
  ...
  public static void main(String[] args) throws Exception {
	  ...
	  for(int i=0;i<10;i++){
		  ...
		  fixedThreadPool.execute(client.get(i));
		  //ThreadList.add(new Thread(client.get(i),Integer.toString(i)));
		  //ThreadList.get(i).start();
	  }
	  for(int i=0;i<10;i++){
		while(!client.get(i).ready){
			Thread.sleep(500);
		}
        if(client.get(i).ready){
		  System.out.println(i+"   "+client.get(i).avgStar.get(0));
		  System.out.println(i+"   "+client.get(i).avgStar.get(1));
		  System.out.println(i+"   "+client.get(i).avgStar.get(2));
		  System.out.println(i+"   "+client.get(i).reviews.get(0).title);
		  System.out.println(i+"   "+client.get(i).imageSrc);
		}
	  }
